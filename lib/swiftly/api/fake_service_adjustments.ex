defmodule Swiftly.API.FakeServiceAdjustments do
  ...
  def create_adjustment_v1(_, _ \\ []) do
    {
      :ok,
      %Swiftly.API.ServiceAdjustments.AdjustmentIdResponse{
        adjustmentId: "0a9b90f5-f16a-4819-b051-565b39878530"
      }
    }
  end
  ...
  def get_adjustments_v1(_ \\ []) do
    {:ok, %Swiftly.API.ServiceAdjustments.AdjustmentsResponseV1{adjustments: []}}
  end
end
