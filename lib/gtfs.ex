defmodule Gtfs do
  ...
  def handle_call(
        {:active_trips_on_route, route_id, start_time, end_time},
        _from,
        {:loaded, gtfs_data} = state
      ) do
    {:reply, Data.active_trips_on_route(gtfs_data, route_id, start_time, end_time), state}
  end
