defmodule Static.Helpers do
  @doc """
  Returns a single list that attempts to keep items in order

  iex> Static.Helpers.merge_lists([[:b, :c], [:a, :b]])
  [:a, :b, :c]

  iex> Static.Helpers.merge_lists([[:c, :a], [:a, :b], [:b, :c]])
  [:c, :a, :b]

  iex> Static.Helpers.merge_lists([[:a, :b]])
  [:a, :b]

  iex> Static.Helpers.merge_lists([])
  []
  """
