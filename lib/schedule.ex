defmodule Schedule do
  ...
  def shapes_with_stops_for_route(route_id, persistent_term_key \\ __MODULE__) do
    call_with_data(persistent_term_key, [route_id], :shape_with_stops_for_all_route_patterns, nil)
  end
