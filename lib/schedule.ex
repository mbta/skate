defmodule Schedule do
  ...
  @spec timepoint_name_for_id(Timepoint.id(), GenServer.server()) :: String.t() | nil
  def timepoint_name_for_id(timepoint_id, server \\ __MODULE__) do
    call_catch_timeout(
      server,
      {:timepoint_name_for_id, timepoint_id},
      :timepoint_name_for_id,
      nil
    )
  end
  ...
  def handle_call({:timepoint_name_for_id, timepoint_id}, _from, {:loaded, gtfs_data} = state) do
    {:reply, Data.timepoint_name_for_id(gtfs_data, timepoint_id), state}
  end
