defmodule Skate.Detours.TripModificationPublisher do
  @moduledoc """
    Connects to the MQTT Broker, then tracks and sends Trip Modifications to the Broker
  ...
  def handle_call(
    ...
    res =
      Skate.MqttConnection.publish_in_topic_prefix(state.connection, %EmqttFailover.Message{
  ...
  defp trip_modification_topic(id), do: "trip_modifications/#{id}/trip_modification"
end
