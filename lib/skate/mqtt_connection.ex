defmodule Skate.MqttConnection do
  ...
  @spec publish_in_topic_prefix(server(), EmqttFailover.Message.t()) :: :ok | {:error, term()}
  def publish_in_topic_prefix(connection, %EmqttFailover.Message{topic: topic} = message) do
    EmqttFailover.Connection.publish(connection, %{
      message
