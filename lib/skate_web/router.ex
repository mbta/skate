defmodule SkateWeb.Router do
  ...
  scope "/", SkateWeb do
    ...
    post "/detours_admin/:id/swiftly_create", DetoursAdminController, :swiftly_create
    delete "/detours_admin/:id/swiftly_delete", DetoursAdminController, :swiftly_delete
