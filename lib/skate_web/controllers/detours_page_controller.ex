defmodule SkateWeb.DetoursPageController do
  require Logger
  ...
  def index(conn, _params) do
    ...
    |> render("index.html", layout: {SkateWeb.Layouts, "detoursApp.html"})
  end
  ...
  def show(conn, %{"id" => id}) do
    ...
    |> assign(:sentry_org_slug, Application.get_env(:skate, :sentry_org_slug))
    |> assign(:detour_id, id)
    |> render("show.html", layout: {SkateWeb.Layouts, "detoursApp.html"})
  end
  ...
  def new(conn, _params) do
    ...
    |> assign(:map_limits, map_limits)
    |> assign(:sentry_org_slug, Application.get_env(:skate, :sentry_org_slug))
    |> assign(:new_detour, "true")
    |> render("new.html", layout: {SkateWeb.Layouts, "detoursApp.html"})
  end
end
