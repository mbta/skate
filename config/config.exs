...
config :laboratory,
  features: [
    ...
    {:route_ladder_crowding, "Crowding Display In Route Ladder",
     "Allows toggling display of routes with crowding data to a mode that shows crowding icons/labels rather than the usual vehicle display"}
  ],
  cookie: [
    # one month,
    max_age: 3600 * 24 * 30,
