...
config :skate,
  ...
  bridge_api_username: {:system, "BRIDGE-API-USERNAME"},
  bridge_api_password: {:system, "BRIDGE-API-PASSWORD"},
  ...
  swiftly_authorization_key: {:system, "SWIFTLY-AUTHORIZATION-KEY"}
