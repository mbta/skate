 ...
 */
export const ExclamationTriangleFillJustSvg = (props: SvgProps) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="16"
    height="16"
...
export const ExclamationTriangleFill = forwardRef(
  (props: SvgProps, ref: React.ForwardedRef<SVGSVGElement>) => (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="16"
      height="16"
...
export const ExclamationTriangleFillWithRef = forwardRef(
  (props: SvgProps, ref: React.ForwardedRef<SVGSVGElement>) => (
    <ExclamationTriangleFillJustSvg {...props} ref={ref} />
  )
)
