    ...
    >
      ...
      {type === StopIconType.Small && (
        <svg viewBox="0 0 14 14" fill="none">
          <circle className="c-stop-icon__focus-circle" cx="7" cy="7" r={5 + strokeWidthOffset} />
          <circle
      ...
      {type === StopIconType.Medium && (
        <svg viewBox="0 0 18 18" fill="none">
          <circle className="c-stop-icon__focus-circle" cx="9" cy="9" r={7 + strokeWidthOffset} />
      ...
      {type === StopIconType.Large && (
        <svg viewBox="0 0 20 20" fill="none">
          <circle className="c-stop-icon__focus-circle" cx="10" cy="10" r={8 + strokeWidthOffset} />
          <circle
            className="c-stop-icon__circle"
            cx="10"
            cy="10"
            r="8"
          />
