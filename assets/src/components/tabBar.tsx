...
const TabBar = ({
  ...
  const logoClass = todayIsHalloween()
    ? "m-tab-bar__logo halloween"
    : "m-tab-bar__logo"
  ...
  return (
    ...
    >
      <button className={logoClass} onClick={() => reload()}>
        {skateLogo}
      </button>
...
const skateLogo = todayIsHalloween() ? (
  <svg viewBox="0 0 55.49 30.12" xmlns="http://www.w3.org/2000/svg">
    <g className="m-tab-bar__icon">
