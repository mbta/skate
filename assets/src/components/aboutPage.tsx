...
const AboutPage = (): ReactElement<HTMLDivElement> => (
  <div className="c-page m-about-page">
    <div className="m-about-page__container">
      <h1 className="m-about-page__title">About Skate</h1>
      <p>
      ...
      <div className="m-about-page__section">
        <h2 className="m-about-page__header">Device Support</h2>
        <p>Need tablet support? Call the MBTA Help Desk at x5761.</p>
      </div>
      <div className="m-about-page__section">
        <h2 className="m-about-page__header">Frequently Asked Questions</h2>
        <p>
      ...
      <div className="m-about-page__section">
        <h2 className="m-about-page__header">Feedback</h2>
        <p>
