...
const Y_CENTER_TO_POINT = 19
const Y_CENTER_TO_BASE = 20

export const VehicleIcon = (props: Props) => {
  props = {
    ...props,
    // ghosts can only be drawn right side up
    orientation: props.status === "ghost" ? Orientation.Up : props.orientation,
  }
...
export const VehicleIconSvgNode = ({
  ...
  // ghosts can only be drawn right side up
  orientation = status === "ghost" ? Orientation.Up : orientation
  return (
    <g
