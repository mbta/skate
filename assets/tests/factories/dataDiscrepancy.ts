...
class DataDiscrepancySourceFactory extends Factory<
  DataDiscrepancySource, DataDiscrepancySourceFactoryTransientParams
> {
...
export const swiftlyDataDiscrepancySourceFactory = dataDiscrepancySourceFactory.dataSource("swiftly");
export const buslocDataDiscrepancySourceFactory = dataDiscrepancySourceFactory.dataSource("busloc");
