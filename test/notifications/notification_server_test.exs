defmodule Notifications.NotificationServerTest do
  ...
  # rename to activated_detour?
  describe "detour_activated/3" do
    setup do
      {:ok, server} = setup_server()
    ...
    test "saves to database" do
      ...
      for _ <- 1..notification_count do
        ...
        NotificationServer.detour_activated(detour, self(), __MODULE__)
    ...
    #     NotificationServer.detour(detour, __MODULE__, self())
